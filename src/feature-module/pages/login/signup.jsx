...
const SignUp = () => {
  ...
  //   const decryptedData = state.decryptedData;
  ...
  return (
    <>
      <ReactLoader open={loading} />
      <div
        className="container-fluid d-flex flex-wrap  ps-0 pe-0 "
      ...
      >
        ...
        >
          <div
            className=" pb-4 p-3 pt-lg-0 pt-md-0 mt-lg-0 mt-md-0 bg-white"
            style={{ height: "100%" }}
          >
            <div className="">
              {/* <img
            ...
            <span>
              <h5 className="text-primary">SignUp Form</h5>
            </span>
            <form className="row g-2" onSubmit={handleOk}>
              ...
              <div className="col-12 d-flex justify-content-center pt-3">
                <button
                  type="submit"
                  className="button-save me-5 px-lg-4 px-3 p-1"
                >
                  Ok
                </button>
              </div>
              <div className="col-12 position-relative">
                ...
                >
                  ...
                  <div className="" style={{ height: "120px", width: "320px" }}>
                    <p>
                      <b>
                        Are You Sure! <br></br> Do You Want to send OTP!{" "}
                      </b>
                    </p>
                  </div>
              ...
              >
                ...
                <div className="col-12 d-flex justify-content-center">
                  {/* <button className='px-4 button-save me-4' type='button'>Register</button> */}
                  <button
              ...
              <div className="col-12 d-flex justify-content-end">
                <span className="pe-5">
                  <NavLink to="/signIn">Go to SignIn Page</NavLink>
                </span>
              </div>
            </form>
          </div>
