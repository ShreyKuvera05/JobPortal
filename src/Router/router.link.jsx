...
import SignUp from "../feature-module/pages/login/signup";
import { element } from "prop-types";
import CandidateEnrollment from "../feature-module/CandidateEnrollment";
export const publicRoutes = [
  ...
  {
    id: 117,
    path: routes.CandidateEnrollment,
    name: "Candidate Enrollment",
    route: Route,
    element: <CandidateEnrollment />,
  },
];
